...
description: >
  Git commit rules following Conventional Commits 1.0.0 (feat, fix, chore, docs, refactor, test, ci, scopes, breaking changes), including not committing automatically unless asked. Use when writing a commit message, committing changes, creating a branch, or pushing to a repository, or when "commit", "git", "branch", or "push" are mentioned.
---
...
The specification above is [Conventional Commits 1.0.0](https://www.conventionalcommits.org/en/v1.0.0/), licensed under [CC BY 3.0](https://creativecommons.org/licenses/by/3.0/).
